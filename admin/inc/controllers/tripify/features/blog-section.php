...
class wl_blog_customizer {
	...
	public static function wl_tripify_blog_customizer( $wp_customize ) {
		 /* Blog Option */
    $wp_customize->add_section( 'blog_section', array(
	    'title'      => __( 'Home Blog Options', WL_COMPANION_DOMAIN),
	    'panel'      => 'tripify_theme_option',
    ...
    $wp_customize->add_setting(
	    ...
	    array(
		    'default'           => 1,
		    'type'              => 'theme_mod',
		    'sanitize_callback' => 'tripify_sanitize_checkbox',
		    'capability'        => 'edit_theme_options'
	    )
    );
    ...
    $wp_customize->add_setting(
	    ...
	    array(
		    ...
		    'sanitize_callback' => 'tripify_sanitize_text',
		    'capability'        => 'edit_theme_options',
	    )
    );
