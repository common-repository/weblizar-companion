...
class wl_team_customizer_new {
	...
	public static function wl_enigma_team_customizer_new( $wp_customize ) {
		...
		$wp_customize->add_section(
	        'team_sec',
	        array(
	            'title' 		  => __('Team Options - Works in Theme Webify Only',WL_COMPANION_DOMAIN),
		...
		require( WL_COMPANION_PLUGIN_DIR_PATH . 'admin/inc/controllers/webify/functions/team-functions.php' );
