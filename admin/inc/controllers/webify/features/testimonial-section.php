...
class wl_testimonial_customizer {
	...
	public static function wl_enigma_testimonial_customizer( $wp_customize ) {
		...
		$wp_customize->add_section(
	        'testimonial_sec',
	        array(
	            'title' 		  => __('Testimonial Options - Works in Theme webify Only',WL_COMPANION_DOMAIN),
		...
		require( WL_COMPANION_PLUGIN_DIR_PATH . 'admin/inc/controllers/webify/functions/testimonial-functions.php' );
